                ...
                <form ref={formRef} preventdefault:submit onSubmit$={()=>formRef.value && handleSubmit(formRef.value)} class={`relative w-full rounded-sm bg-white bg-opacity-40`}>
                    ...
                    <div class="p-3 pb-10 flex w-full flex-col lg:flex-row justify-between flex-wrap items-center lg:justify-start">
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <input required name="first_name" type="text" id="first_name" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5" />
                        </div>
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <input required name="surname_name" type="text" id="surname_name" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5" />
                        </div>
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <input required type="text" name="email" id="email" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5" />
                        </div>
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <input required name="phone" type="text" id="phone" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5" />
                        </div>
                    </div>
                    ...
                    <div class="p-3 flex w-full flex-col lg:flex-row justify-between items-center gap-6">
                        ...
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <select required name="passengers" id="passengers" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5">
                        ...
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <select required name="pickup_address" id="pickup_address" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5">
                                <option value="" >-----</option>
                        ...
                        <div class="w-full lg:w-1/3 px-3">
                            ...
                            <select required name="dropoff_address" id="dropoff_address" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm focus:outline-none focus::border-none block w-full p-2.5">
                            <option value="" >-----</option>
