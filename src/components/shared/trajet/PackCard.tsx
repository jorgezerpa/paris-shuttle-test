...
export default component$(() => {
  return (
    ...
    <div class=" w-full  bg-[#e2e2e2]  min-w-[300px] gap-10 py-10  mt-[20px]  md:max-h-[400px]">
      <div class="flex md:flex-row ml-0 flex-col lg:mx-auto lg:max-w-7xl w-full">
        <img class="md:w-[25rem] mx-10 max-h-[300px]" src="/images/photos_vehicules.jpg" alt="Photo Véhicule"/>
