...
export default component$(() => {
  ...
  return (
    <div class=''>
      ...
      <div class="md:px-1 px-5 w-full  max-w-7xl mx-auto">
        <div class="w-full py-10 flex items-center justify-center gap-10 lg:flex-row flex-col">
          <div class='w-full'>
            <div class="border-b border-b-primary-dark mb-5">
              <h2 class="lg:text-3xl text-2xl text-primary-dark font-bold">TRANSFERTS ENTRE LES AÉROPORTS, PARIS ET DINEYLAND.</h2>
            </div>
      ...
      <div class='bg-gray-200'>
        ...
        <div class='py-1 w-full  max-w-7xl mx-auto'>
        <div class="border-b border-b-primary-dark mb-5 mt-10 md:mx-10 mx-5 ">
          <h2 class="lg:text-3xl text-2xl text-white md:text-primary-dark font-bold">NOS PACK FAMILY DISNEYLAND.</h2>
        </div>
        <div class="flex justify-center pb-10">
          <div class="flex flex-col lg:flex-row  items-center justify-center flex-wrap lg:flex-nowrap px-1  gap-5 w-full max-w-[1300px]  ">
            <div class=" bg-white w-full lg:w-auto flex justify-center items-center flex-col">
              ...
              <p class="text-primary-dark text-lg text-center py-6 px-1 font-bold">CHARLES DE GAULLE (CDG) ⇄ DISNEYLAND</p>
            ...
            <div class=" bg-white w-full lg:w-auto flex justify-center items-center flex-col">
              ...
              <p class="text-primary-dark text-lg text-center py-6 px-1 font-bold">ORLY ⇄ DISNEYLAND</p>
              <div class="flex justify-center w-full">
                <button type='submit' class='bg-primary-dark hover:bg-[#4D5E84] text-white font-bold py-2 w-full'>
                  En savoir plus
                </button>
