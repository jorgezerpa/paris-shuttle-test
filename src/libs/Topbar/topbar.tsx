...
export default component$(({ showNavbar }: { showNavbar: { value: boolean } }) => {
  return (
    <>
      <div class={`bg-primary-dark w-full hidden lg:flex justify-center items-center py-3 px-2 lg:h-[4rem]`}>
        <div class={`w-full max-w-6xl flex justify-between items-center`}>

          <div class='flex-1'>
            <a href="#">
              <img src='/images/logo.png' class='h-[3.5rem] flex justify-center' />
            </a>
          </div>

          <div class='flex-1'>
            <h2 class='text-center text-white font-bold text-[1.05rem] font-opensans'>VOYAGEZ EN TOUTE SÉRÉNITÉ !</h2>
            <h4 class='text-center text-white font-opensans font-normal text-[0.8rem]'>Service sur mesure, à tarifs fixes.</h4>
          </div>
          ...
          <div class='flex-1 flex justify-end items-center gap-5 text-white'>
            ...
            <div>
              <div class="h-[1.5rem] text-gray-600 text-[0.8rem] pr-[10px] bg-white rounded-2xl flex gap-2 items-center">
                <div class="w-[3rem] h-full bg-[#3E3E3E] rounded-2xl flex justify-center items-center">
      ...
      <div class={`bg-primary-dark w-full flex lg:hidden justify-center items-center py-2 px-3`}>
        <div class={`w-full max-w-[74rem] flex justify-between items-center py-3`}>
          ...
          <div class='flex-1 flex-shrink-0 flex justify-center'>
            <a href="#" >
              <img src='/images/logo.png' class='h-[2.5rem] min-w-[9.89rem]' />
            </a>
          </div>
