...
export default component$(({ isFixed = false }: { isFixed?: boolean }) => {
    const ITEMS = [
        // { title:'Accueil', path:'/' },
        { title: 'Orly', path: '/trajet', subitems: ['Paris', 'Disneyland', 'Charles de Gaulle (CDG)', 'Beauvies'] },
        { title: 'Disneyland', path: '/trajet', subitems: ['Paris', 'Orly', 'Charles de Gaulle (CDG)', 'Beauvies'] },
        { title: 'Paris', path: '/trajet', subitems: ['Beauvais', 'Orly', 'Charles de Gaulle (CDG)', 'Disneyland'] },
        { title: 'Charles de Gaulle (CDG)', path: '/trajet', subitems: ['Disneyland', 'Paris', 'Beauvies', 'Orly'] },
        { title: 'Beauvais', path: '/trajet', subitems: ['Disneyland', 'Orly', 'Paris', 'Charles de Gaulle (CDG)'] },
    ];
